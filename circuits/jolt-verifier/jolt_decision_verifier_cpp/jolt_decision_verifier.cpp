...
void OR_7_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void OR_7_run(uint ctx_index,Circom_CalcWit* ctx);
...
void JOLTDecisionVerifier_11_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void JOLTDecisionVerifier_11_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 158;}

uint get_number_of_components() {return 25;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 118;}
...
{
std::string new_cmp_name = "n2b";
Num2Bits_8_create(mySignalStart+3,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
if (!Fr_isTrue(&circuitConstants[1])) std::cout << "Failed assert in template/function " << myTemplateName << " line 90. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
...
{
std::string new_cmp_name = "lt";
LessThan_9_create(mySignalStart+3,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
ctx->componentMemory[coffset].templateName = "JOLTDecisionVerifier";
ctx->componentMemory[coffset].signalStart = soffset;
...
int cmp_index_ref_load = -1;
{
std::string new_cmp_name = "decisionBinary";
IsZero_0_create(mySignalStart+39,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "confInRange";
LessEqThan_3_create(mySignalStart+6,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "confNonNegative";
GreaterEqThan_4_create(mySignalStart+21,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "confValid";
AND_5_create(mySignalStart+36,6+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 6+ctx_index+1;
}
{
std::string new_cmp_name = "thresholdCheck";
GreaterEqThan_4_create(mySignalStart+62,15+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 15+ctx_index+1;
}
{
std::string new_cmp_name = "notDecision";
NOT_6_create(mySignalStart+57,13+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 13+ctx_index+1;
}
{
std::string new_cmp_name = "implication";
OR_7_create(mySignalStart+54,12+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 12+ctx_index+1;
}
{
std::string new_cmp_name = "proofHashNonZero";
IsZero_0_create(mySignalStart+59,14+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 14+ctx_index+1;
}
{
std::string new_cmp_name = "timestampMin";
GreaterThan_10_create(mySignalStart+114,20+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 20+ctx_index+1;
}
{
std::string new_cmp_name = "timestampMax";
LessThan_9_create(mySignalStart+77,18+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 18+ctx_index+1;
}
{
std::string new_cmp_name = "timestampValid";
AND_5_create(mySignalStart+154,23+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 23+ctx_index+1;
}
{
std::string new_cmp_name = "finalAnd1";
AND_5_create(mySignalStart+42,8+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 8+ctx_index+1;
}
{
std::string new_cmp_name = "finalAnd2";
AND_5_create(mySignalStart+45,9+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[12] = 9+ctx_index+1;
}
{
std::string new_cmp_name = "finalAnd3";
AND_5_create(mySignalStart+48,10+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[13] = 10+ctx_index+1;
}
{
std::string new_cmp_name = "finalAnd4";
AND_5_create(mySignalStart+51,11+ctx_index+1,ctx,new_cmp_name,myId);
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 1],&circuitConstants[1]); // line circom 40
Fr_mul(&expaux[0],&signalValues[mySignalStart + 1],&expaux[1]); // line circom 40
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
cmp_index_ref_load = 0;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&circuitConstants[1]); // line circom 41
}}
...
cmp_index_ref_load = 3;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + 0],&circuitConstants[1]); // line circom 55
}}
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
OR_7_run(mySubcomponents[cmp_index_ref],ctx);
}
{
cmp_index_ref_load = 6;
cmp_index_ref_load = 6;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[6]].signalStart + 0],&circuitConstants[1]); // line circom 73
}}
...
cmp_index_ref_load = 7;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[7]].signalStart + 0],&circuitConstants[0]); // line circom 78
}}
...
cmp_index_ref_load = 10;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[10]].signalStart + 0],&circuitConstants[1]); // line circom 93
}}
...
cmp_index_ref_load = 7;
cmp_index_ref_load = 7;
Fr_sub(&expaux[0],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[7]].signalStart + 0]); // line circom 106
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
JOLTDecisionVerifier_11_create(1,0,ctx,"main",0);
JOLTDecisionVerifier_11_run(0,ctx);
}
