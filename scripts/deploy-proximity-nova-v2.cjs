...
async function deployProximityNovaV2() {
    // Configuration
    ...
    try {
        // Step 1: Deploy ProximityNovaDecider V2 (with view function)
        console.log('Step 1: Deploying ProximityNovaDecider V2...');
        ...
        console.log('✅ ProximityNovaDecider V2 deployed at:', proximityNova.options.address);
        
        // Step 2: Deploy IoTeXDeviceVerifierV3 with new Nova Decider
        console.log('\nStep 2: Deploying IoTeXDeviceVerifierV3 with new Nova Decider...');
        ...
        const deploymentPath = path.join(__dirname, '../deployments/proximity-nova-deployment-v2.json');
...
deployProximityNovaV2().catch(console.error);