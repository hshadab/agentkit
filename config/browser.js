// Browser-compatible configuration for AgentKit frontend
// This file is safe to include in browser bundles
...
export const config = {
  ...
  // Circle configuration (public info only)
  circle: {
    developerWallet: {
  ...
  getNetworkByChainId(chainId) {
    ...
    return Object.values(this.blockchain).find(n => n.chainIdDecimal === chainIdNum);
  }
};
