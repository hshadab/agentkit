#!/usr/bin/env python3
"""
Update cache buster for BigInt JSON serialization fix
"""
import re
import os

def update_cache_version():
    new_version = "20250822-194000"
    old_version = "20250822-193500"
    ...
    print("   This will force browsers to reload the BigInt serialization fix")
