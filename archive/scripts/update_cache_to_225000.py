#!/usr/bin/env python3
"""
Update cache buster version to force browser refresh for runtime fixes
"""
import re
import os

def update_cache_version():
    new_version = "20250822-225000"
    old_version = "20250822-224000"
    ...
    print("   This will force browsers to reload the runtime-fixed files")
