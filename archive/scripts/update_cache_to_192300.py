#!/usr/bin/env python3
"""
Update cache buster version after server restart fixes
"""
import re
import os

def update_cache_version():
    new_version = "20250822-192300"
    old_version = "20250822-192235"
    ...
    print("   This will force browsers to reload the fixed Gateway workflow after restart")
