# AgentKit Architecture (Demo/Testnet)

## System Overview

AgentKit is a modular demo/prototype for generating and verifying zero‑knowledge proofs across multiple blockchains (primarily public testnets) with automated transfers. It is not production‑ready.
...
### 4. zkEngine Binary (Nova Proofs — Demo)
...
**Notes**:
- Some flows are demonstrated end‑to‑end on testnets; others may be simulated.
- Where configured, proofs are generated by the binary and verified on testnets.
